...
export default function Billing() {
  ...
  return (
    <div>
      <p className="text-white/70">Choose a plan that fits your needs. Current plan: <span className="badge capitalize">{user?.plan || 'basic'}</span></p>

      <div className="grid md:grid-cols-3 gap-6 mt-8">
        {plans.map((p) => (
          <div key={p.key} className="bg-black/20 border border-white/10 rounded-lg p-5 flex flex-col">
